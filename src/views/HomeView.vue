...
import HreoSection from '@/components/HeroSection.vue'
...
<template>
  ...
  <!-- Page: Homepage - Section: Hreo -->
  <HreoSection id="info" v-for="(item, index) in homepageHeroData" :key="index" v-bind="item" />
