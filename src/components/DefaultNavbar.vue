  ...
  <div id="defaultNavbar" :class="{
    ...
    <nav class="flex items-center mx-auto justify-between py-2 px-5">
      ...
      <div class="hidden lg:block">
        ...
        -->
        <a href="https://lin.ee/2J3meSM" target="_blank" rel="noopener noreferrer">
          <img src="https://scdn.line-apps.com/n/line_add_friends/btn/zh-Hant.png" alt="加入好友" class="h-9">
        </a>
      </div>
